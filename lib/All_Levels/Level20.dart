...
class Level20QuestionPage extends StatefulWidget {
  const Level20QuestionPage({super.key});

  @override
  State<Level20QuestionPage> createState() => _Level20QuestionPageState();
}

class _Level20QuestionPageState extends State<Level20QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'VENEZUELA';
  ...
  final List<String> imagePaths = [
    ...
    'images/venezuela2.jpg',
    'images/venezuela3.jpg',
    'images/venezuela4.jpg',
  ];
