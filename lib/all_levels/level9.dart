...
class Level9QuestionPage extends StatefulWidget {
  const Level9QuestionPage({super.key});

  @override
  State<Level9QuestionPage> createState() => _Level9QuestionPageState();
}

class _Level9QuestionPageState extends State<Level9QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'CANADA';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(9);
    } else {
      _shakeController
        ..reset()
        ..forward();
