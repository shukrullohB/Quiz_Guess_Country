...
class Level12QuestionPage extends StatefulWidget {
  const Level12QuestionPage({super.key});

  @override
  State<Level12QuestionPage> createState() => _Level12QuestionPageState();
}

class _Level12QuestionPageState extends State<Level12QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'INDIA';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(12);
    } else {
      _shakeController
        ..reset()
        ..forward();
