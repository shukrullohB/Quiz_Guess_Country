...
class Level2QuestionPage extends StatefulWidget {
  ...
  @override
  State<Level2QuestionPage> createState() => _Level2QuestionPageState();
}

class _Level2QuestionPageState extends State<Level2QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'THAILAND';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(2);
    } else {
      _shakeController
        ..reset()
        ..forward();
      ...
      floatingActionButton: checkedCorrect
        ...
        onPressed: () {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (_) => const Level3QuestionPage(),
            ),
          );
        },
      )
