...
class Level22QuestionPage extends StatefulWidget {
  const Level22QuestionPage({super.key});
  @override
  State<Level22QuestionPage> createState() => _Level22QuestionPageState();
}

class _Level22QuestionPageState extends State<Level22QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'CUBA';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(22);
    } else {
      _shakeController
        ..reset()
        ..forward();
