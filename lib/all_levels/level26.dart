...
class Level26QuestionPage extends StatefulWidget {
  const Level26QuestionPage({super.key});
  @override
  State<Level26QuestionPage> createState() => _Level26QuestionPageState();
}

class _Level26QuestionPageState extends State<Level26QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'IRELAND';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(26);
    } else {
      _shakeController
        ..reset()
        ..forward();
