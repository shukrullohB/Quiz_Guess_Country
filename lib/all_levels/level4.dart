...
class Level4QuestionPage extends StatefulWidget {
  const Level4QuestionPage({super.key});

  @override
  State<Level4QuestionPage> createState() => _Level4QuestionPageState();
}

class _Level4QuestionPageState extends State<Level4QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'ITALY';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(4);
    } else {
      _shakeController
        ..reset()
        ..forward();
