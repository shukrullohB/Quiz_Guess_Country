...
class Level15QuestionPage extends StatefulWidget {
  const Level15QuestionPage({super.key});

  @override
  State<Level15QuestionPage> createState() => _Level15QuestionPageState();
}

class _Level15QuestionPageState extends State<Level15QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'EGYPT';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(15);
    } else {
      _shakeController
        ..reset()
        ..forward();
