...
class Level18QuestionPage extends StatefulWidget {
  const Level18QuestionPage({super.key});
  @override
  State<Level18QuestionPage> createState() => _Level18QuestionPageState();
}

class _Level18QuestionPageState extends State<Level18QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'MALTA';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(18);
    } else {
      _shakeController
        ..reset()
        ..forward();
