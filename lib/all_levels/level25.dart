...
class Level25QuestionPage extends StatefulWidget {
  const Level25QuestionPage({super.key});

  @override
  State<Level25QuestionPage> createState() => _Level25QuestionPageState();
}

class _Level25QuestionPageState extends State<Level25QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'LEBANON';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(25);
    } else {
      _shakeController
        ..reset()
        ..forward();
          ...
          ? FloatingActionButton.extended(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => const Level26QuestionPage(),
                  ),
                );
              },
            )
