...
class Level27QuestionPage extends StatefulWidget {
  const Level27QuestionPage({super.key});
  @override
  State<Level27QuestionPage> createState() => _Level27QuestionPageState();
}

class _Level27QuestionPageState extends State<Level27QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'GEORGIA';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(27);
    } else {
      _shakeController
        ..reset()
        ..forward();
          ...
          ? FloatingActionButton.extended(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => const Level28QuestionPage(),
                  ),
                );
              },
            )
