...
class Level8QuestionPage extends StatefulWidget {
  const Level8QuestionPage({super.key});
  @override
  State<Level8QuestionPage> createState() => _Level8QuestionPageState();
}

class _Level8QuestionPageState extends State<Level8QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'BRAZIL';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(8);
    } else {
      _shakeController
        ..reset()
        ..forward();
