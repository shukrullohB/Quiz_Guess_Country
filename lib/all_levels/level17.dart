...
class _Level17QuestionPageState extends State<Level17QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'ARGENTINA';
  ...
  final List<String> imagePaths = [
    ...
    'images/argentina2.jpg',
    'images/argentina3.jpg',
    'images/argentina4.jpg',
  ];
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(17);
    } else {
      _shakeController
        ..reset()
        ..forward();
          ...
          ? FloatingActionButton.extended(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => const Level18QuestionPage(),
                  ),
                );
              },
            )
