...
class Level5QuestionPage extends StatefulWidget {
  const Level5QuestionPage({super.key});

  @override
  State<Level5QuestionPage> createState() => _Level5QuestionPageState();
}

class _Level5QuestionPageState extends State<Level5QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'POLAND';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(5);
    } else {
      _shakeController
        ..reset()
        ..forward();
