...
class Level7QuestionPage extends StatefulWidget {
  const Level7QuestionPage({super.key});
  @override
  State<Level7QuestionPage> createState() => _Level7QuestionPageState();
}

class _Level7QuestionPageState extends State<Level7QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'GREENLAND';
  ...
  final List<String> imagePaths = [
    ...
    'images/greenland2.jpg',
    'images/greenland3.jpg',
    'images/greenland4.jpg',
  ];
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(7);
    } else {
      _shakeController
        ..reset()
        ..forward();
