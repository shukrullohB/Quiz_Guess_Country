...
class Level24QuestionPage extends StatefulWidget {
  const Level24QuestionPage({super.key});

  @override
  State<Level24QuestionPage> createState() => _Level24QuestionPageState();
}

class _Level24QuestionPageState extends State<Level24QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'BULGARIA';
  ...
  final List<String> imagePaths = [
    'images/bulgaria.jpg',
    'images/bulgaria2.jpg',
    'images/bulgaria3.jpg',
    'images/bulgaria4.jpg',
  ];
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(24);
    } else {
      _shakeController
        ..reset()
        ..forward();
