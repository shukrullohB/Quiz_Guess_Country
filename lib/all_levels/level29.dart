...
class Level29QuestionPage extends StatefulWidget {
  const Level29QuestionPage({super.key});

  @override
  State<Level29QuestionPage> createState() => _Level29QuestionPageState();
}

class _Level29QuestionPageState extends State<Level29QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'INDONESIA';
  ...
  final List<String> imagePaths = [
    ...
    'images/indonesia3.jpg',
    'images/indonesia4.jpg',
  ];
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(29);
    } else {
      _shakeController
        ..reset()
        ..forward();
          ...
          ? FloatingActionButton.extended(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => const Level30QuestionPage(),
                  ),
                );
              },
            )
