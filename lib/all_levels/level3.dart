...
class Level3QuestionPage extends StatefulWidget {
  const Level3QuestionPage({super.key});

  @override
  State<Level3QuestionPage> createState() => _Level3QuestionPageState();
}

class _Level3QuestionPageState extends State<Level3QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'GERMANY';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(3);
    } else {
      _shakeController
        ..reset()
        ..forward();
