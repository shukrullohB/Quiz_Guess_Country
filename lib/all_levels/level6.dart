...
class Level6QuestionPage extends StatefulWidget {
  const Level6QuestionPage({super.key});

  @override
  State<Level6QuestionPage> createState() => _Level6QuestionPageState();
}

class _Level6QuestionPageState extends State<Level6QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'SPAIN';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(6);
    } else {
      _shakeController
        ..reset()
        ..forward();
