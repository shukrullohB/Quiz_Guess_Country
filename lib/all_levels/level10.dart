...
class Level10QuestionPage extends StatefulWidget {
  const Level10QuestionPage({super.key});

  @override
  State<Level10QuestionPage> createState() => _Level10QuestionPageState();
}

class _Level10QuestionPageState extends State<Level10QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'SWITZERLAND';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(10);
    } else {
      _shakeController
        ..reset()
        ..forward();
