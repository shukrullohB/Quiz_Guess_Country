...
class Level16QuestionPage extends StatefulWidget {
  const Level16QuestionPage({super.key});
  @override
  State<Level16QuestionPage> createState() => _Level16QuestionPageState();
}

class _Level16QuestionPageState extends State<Level16QuestionPage>
    with SingleTickerProviderStateMixin {
  final String answer = 'VIETNAM';
  ...
  void _onCheck() {
    ...
    if (isCorrect) {
      _confettiController
        ..stop()
        ..play();
      ProgressRepository().markCompleted(16);
    } else {
      _shakeController
        ..reset()
        ..forward();
          ...
          ? FloatingActionButton.extended(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => const Level17QuestionPage(),
                  ),
                );
              },
            )
